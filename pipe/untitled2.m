% function [coeff] = PT(bnd_L,bnd_R,mode_in,modes,wd,kd,Amp,Coordinate,Nnode,lambda,mu,density,h, Kg)

[Ko,Kl,Kr,l,r,o] = Stiffness_Changed_Position(Kg,bnd_L,bnd_R,Nnode); % 交换刚度矩阵位置
%% 左边界入射模态的节点位移/力
bnd = bnd_L;
n = mode_in;
